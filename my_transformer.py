...
class TransformerEncoderLayer(nn.TransformerEncoderLayer):
    ...
    def __init__(self, d_model, nhead, dim_feedforward=2048, dropout=0.1, relative_positional=True, relative_positional_distance=100):
        super(TransformerEncoderLayer, self).__init__(d_model, nhead)
        self.batch_first=True
        self.self_attn = MultiHeadAttention(d_model, nhead, batch_first=self.batch_first, dropout=dropout, relative_positional=relative_positional, relative_positional_distance=relative_positional_distance)
        self.self_attn.batch_first = self.batch_first
